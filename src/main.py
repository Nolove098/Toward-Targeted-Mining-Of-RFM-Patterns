...
def main():
    ...
    default_tx = os.path.join(base_dir, "data", "sample", "foodmartFIM.txt")
    default_util = os.path.join(base_dir, "data", "sample", "external_utility.txt")
    
    parser.add_argument("--tx", default=default_tx, help="Path to transactions file")
    parser.add_argument("--util", default=default_util, help="Path to external utility file")
    parser.add_argument("--qi", default="214,763", help="Query items separated by comma")
    parser.add_argument("--delta", type=float, default=0.01, help="Decay rate")
    parser.add_argument("--gamma", type=float, default=0.2, help="Min recency")
    parser.add_argument("--alpha", type=float, default=0.01, help="Min frequency ratio")
    parser.add_argument("--beta", type=float, default=10.0, help="Min monetary")
